...
TEXTS: dict[str, dict[str, str]] = {
    "es": {
        ...
        "what_text": "Subí archivos de diseño, miralos antes de usarlos y descargalos en otro formato compatible para tus proyectos de corte o grabado láser.",
        ...
        "file_error_text": "Probá convertirlo a otro formato o revisá que el archivo original se abra correctamente en tu programa de diseño.",
        "file": "Archivo",
        ...
        "available_text": "La herramienta acepta archivos <strong>DXF, SVG, PDF y PNG</strong>. Una vez cargado el archivo, vas a poder elegir el formato de salida disponible y descargarlo.",
    ...
    "en": {
        ...
        "what_text": "Upload design files, preview them before using them, and download them in another compatible format for your laser cutting or engraving projects.",
        ...
        "file_error_text": "Try converting it to another format, or check that the original file opens correctly in your design software.",
        "file": "File",
        ...
        "available_text": "This tool supports <strong>DXF, SVG, PDF, and PNG</strong> files. Once your file is uploaded, you can choose an available output format and download it.",
